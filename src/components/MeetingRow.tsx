...
import { Clock, CheckCircle2, Loader2, AlertCircle, ExternalLink, Video, Music, Tag, Layers, Timer, Cpu } from "lucide-react";
...
export function MeetingRow({ id, title, date, duration, status, source, mediaType, calendarEventUrl, category, tags, meetingType, autoCategories, transcribeStartTime, whisperModel, whisperDevice }: MeetingRowProps) {
